...
document.querySelectorAll('section img, .comp-image img, .slider-item').forEach(img => {
    // Make sure we don't apply it to very small icons or the loading screen
    if (img.closest('#loading-screen') || img.classList.contains('comp-icon')) return;

    img.style.cursor = 'zoom-in'; // Visual feedback
